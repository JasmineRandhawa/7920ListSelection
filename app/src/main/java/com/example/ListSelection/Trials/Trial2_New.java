package com.example.ListSelection.Trials;
...
public class Trial2_New extends AppCompatActivity {
    ...
    //computed variables
    final Context context = com.example.ListSelection.Trials.Trial2_New.this;  //context of current screen
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextScreenIntent = new Intent(this, com.example.ListSelection.Trials.Trial3_Old.class);
